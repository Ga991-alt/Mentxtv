...
const PostSession = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/api/mentors/${mentorId}`,
        {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Create a new mentorship session for students to book.
          </p>
        </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {sessionData.type === "group" ? (
                  ...
                  <div className="hidden">
                    <Input id="totalSlots" type="hidden" value="1" />
                  </div>
                )}
                <div
                  className={
                    sessionData.type === "onetoone" ? "col-span-2" : ""
                  }
                >
                  <Label htmlFor="price">Price (₹) *</Label>
                  <Input
