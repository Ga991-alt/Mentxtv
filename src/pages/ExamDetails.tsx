...
const ExamDetails = () => {
  ...
  const examDetails = {
    "IIT (JEE)": {
      ...
      description:
        "The Joint Entrance Examination (JEE) is India's largest engineering entrance examination for undergraduate B.Tech and B.Arch courses in top institutes like IITs, NITs, IIITs, and CFTIs. JEE is conducted in two phases: JEE Main (by NTA) and JEE Advanced (by a designated IIT on rotation each year).",
      overview: {
        title: "JEE Main 2026 Overview",
        content:
          "JEE Main 2026 serves as the qualifying exam for NITs, IIITs, CFTIs, as well as eligibility for JEE Advanced. It is expected to remain a two-session exam in January and April, with a familiar format (MCQ and numerical value questions). For latest notifications, always refer to the official NTA JEE Main portal.",
        papers: [
      ...
      previousYearLink:
        "https://jeemain.nta.nic.in/previous-year-question-papers/",
      examDates: [
        {
          event: "JEE Main 2026 Registration Start Date",
          date: "November 2025",
        },
        { event: "Last Date To Apply Online", date: "December 2025" },
        {
          event: "JEE Main 2026 Admit Card Release Date",
        ...
        {
          event: "JEE Main 2026 Result Announcement",
          date: "A Week After Each Session",
        },
      ],
      eligibility: [
        {
          criteria: "Qualifying Exam",
          details:
            "Completed Class 12 or Equivalent From A Recognized Board/University Or A 3-Year Diploma Recognized By AICTE.",
        },
        {
          criteria: "Nationality",
          details: "Indian Citizens, NRIs, PIOs, And OCIs Are Eligible.",
        },
        {
          criteria: "Subject Requirements",
          details:
            "B.Tech (Paper 1): Physics, Mathematics, And One Additional Subject (Chemistry/Biology/Technical Vocational Subject). B.Arch (Paper 2A): Physics, Chemistry, And Mathematics. B.Plan (Paper 2B): Mathematics.",
        },
      ],
      syllabus: {
        mathematics: [
      ...
      examPattern: [
        {
          particular: "Mode of Exam",
          paper1: "Computer-based (Online)",
          paper2A: "Online (Aptitude/Math) & Offline (Drawing)",
          paper2B: "Online",
        },
        {
          particular: "Duration",
        ...
        },
        {
          ...
          paper1: "3 (Physics, Chemistry, Mathematics)",
          paper2A: "3 (Mathematics, Aptitude, Drawing)",
          paper2B: "3 (Mathematics, Aptitude, Planning)",
        },
        {
          particular: "Total Number of Questions",
          paper1: "75",
          paper2A: "77",
          paper2B: "100",
        },
        ...
        },
        {
          ...
          paper1: "MCQs, Numerical values",
          paper2A:
            "Mathematics: MCQs + Numerical, Aptitude: MCQs, Drawing (Offline)",
          paper2B:
            "Mathematics: MCQs + Numerical, Aptitude: MCQs, Planning: MCQs",
        },
        {
          particular: "Marking Scheme",
          paper1: "+4 for correct, -1 for incorrect, 0 for unattempted",
          paper2A: "+4 for correct, -1 for incorrect (50 marks for Drawing)",
          paper2B: "+4 for correct, -1 for incorrect",
        },
        {
          particular: "Languages",
          paper1: "13 languages available (English, Hindi, regional)",
          paper2A: "13 languages available",
          paper2B: "13 languages available",
        },
      ],
      advanced: {
        ...
        description:
          "JEE Advanced is for students qualifying JEE Main and aiming for IIT admission. Structure and eligibility change slightly each year based on IIT organizing the exam (2025: IIT Kanpur).",
        previousYearLink:
          "https://jeemain.nta.nic.in/previous-year-question-papers/",
        examDates: [
          {
          ...
          {
            activity:
              "Copy of candidate responses available on the JEE (Advanced) 2025 website",
            date: "May 22, 2025",
          },
          {
            activity: "Release of provisional answer keys",
            date: "May 26, 2025",
          },
          {
            activity: "Challenge window of provisional answer keys",
            date: "May 26 to 27, 2025",
          },
          {
            activity:
              "Online Announcement of JEE Advanced 2025 Final Answer Key and Results",
            date: "June 2, 2025",
          },
        ],
      },
    ...
    NEET: {
      ...
      description:
        "The National Eligibility cum Entrance Test (NEET) is the single entrance examination for admission to MBBS, BDS, AYUSH and other medical courses in India. It is conducted by the National Testing Agency (NTA).",
      overview: {
        title: "NEET 2026 Overview",
        content:
          "NEET 2026 is expected to be conducted in May 2026. The exam will be conducted in offline mode (pen and paper based) in multiple languages including English, Hindi, and regional languages.",
        papers: [
      ...
      previousYearLink: "https://www.neetprep.com/papers-test-series",
      examDates: [
      ...
      eligibility: [
        {
          criteria: "Qualifying Exam",
          details:
            "Must have passed Class 12th with Physics, Chemistry, Biology/Biotechnology and English",
        },
        {
          criteria: "Age Limit",
          details:
            "Minimum 17 years, maximum 25 years (30 for reserved categories)",
        },
        {
          criteria: "Minimum Marks",
          details: "50% in PCB for General/OBC, 40% for SC/ST/OPH",
        },
      ],
    },
    UPSC: {
      ...
      description:
        "The Union Public Service Commission conducts the Civil Services Examination to recruit candidates for various Group A and Group B central services like IAS, IFS, IPS, and other allied services.",
      overview: {
        title: "UPSC CSE 2026 Overview",
        content:
          "The UPSC Civil Services Exam consists of three stages: Preliminary Examination (objective type), Main Examination (written), and Personality Test (Interview). The entire process takes about one year to complete.",
        papers: [
      ...
      previousYearLink:
        "https://upsc.gov.in/examinations/previous-question-papers/archives",
      examDates: [
      ...
      eligibility: [
        {
          ...
          details: "Bachelor's degree from recognized university",
        },
        {
          criteria: "Age Limit",
          details: "21-32 years (relaxation for reserved categories)",
        },
        {
          criteria: "Attempt Limit",
          details: "6 attempts for General, 9 for OBC, unlimited for SC/ST",
        },
      ],
    },
    BITSAT: {
      ...
      description:
        "Birla Institute of Technology and Science Admission Test (BITSAT) is conducted by BITS Pilani for admission to its campuses in Pilani, Goa, and Hyderabad for various undergraduate engineering programs.",
      overview: {
        title: "BITSAT 2026 Overview",
        content:
          "BITSAT is a computer-based online test. The exam tests proficiency in Physics, Chemistry, Mathematics, English Proficiency & Logical Reasoning.",
        papers: [
      ...
      previousYearLink:
        "https://engineering.careers360.com/articles/bitsat-previous-year-question-paper-pdf",
      examDates: [
      ...
      eligibility: [
        {
          criteria: "Educational Qualification",
          details: "12th pass with PCM and English, minimum 75% marks",
        },
    ...
    GATE: {
      ...
      description:
        "Graduate Aptitude Test in Engineering (GATE) is conducted for admission to postgraduate programs in engineering, technology, and architecture, and for recruitment in PSUs.",
      overview: {
        title: "GATE 2026 Overview",
        content:
          "GATE is conducted jointly by IISc and seven IITs. The exam is conducted in 27 subjects/papers. It's a computer-based test.",
        papers: [
      ...
      previousYearLink: "https://gate2025.iitr.ac.in/question-papers.html",
      examDates: [
      ...
      eligibility: [
        {
          criteria: "Educational Qualification",
          details: "BE/B.Tech or currently in final year",
        },
        { criteria: "Age Limit", details: "No age limit" },
    ...
    CLAT: {
      ...
      description:
        "Common Law Admission Test (CLAT) is conducted for admission to undergraduate and postgraduate law programs in National Law Universities across India.",
      overview: {
        title: "CLAT 2026 Overview",
        content:
          "CLAT is conducted in offline mode. The UG exam tests English, Current Affairs, Legal Reasoning, Logical Reasoning, and Quantitative Techniques.",
        papers: [
      ...
      previousYearLink:
        "https://www.careerindia.com/exam/clat-question-papers-e29.html",
      examDates: [
      ...
      eligibility: [
        {
          criteria: "UG CLAT",
          details: "12th pass with 45% marks (40% for SC/ST)",
        },
        {
          criteria: "PG CLAT",
          details: "LLB degree with 50% marks (45% for SC/ST)",
        },
    ...
    CA: {
      ...
      description:
        "Chartered Accountancy is conducted by the Institute of Chartered Accountants of India (ICAI). It consists of three levels: Foundation, Intermediate, and Final.",
      overview: {
        title: "CA 2026 Overview",
        content:
          "CA course has three levels. Students can enter at Foundation level after 12th or Intermediate level after graduation. Each level has specific subjects and requirements.",
        papers: [
          "Foundation: 4 papers",
      ...
      previousYearLink:
        "https://boslive.icai.org/education_content.php?c=foundation&p=Question+Papers",
      examDates: [
      ...
      eligibility: [
        ...
        {
          criteria: "Final",
          details: "Intermediate pass + 3 years articleship",
        },
      ],
    },
    NIFT: {
      ...
      description:
        "National Institute of Fashion Technology conducts entrance examination for admission to undergraduate and postgraduate programs in fashion and design.",
      overview: {
        title: "NIFT 2026 Overview",
        content:
          "NIFT entrance exam consists of written test and situation test/group discussion/interview depending on the program.",
        papers: [
      ...
      previousYearLink: "https://www.nift.ac.in/samplequestion",
      examDates: [
    ...
    CAT: {
      ...
      description:
        "Common Admission Test (CAT) is conducted for admission to MBA programs in IIMs and other top B-schools in India.",
      overview: {
        title: "CAT 2026 Overview",
        content:
          "CAT is a computer-based test conducted annually. The exam tests Verbal Ability, Data Interpretation & Logical Reasoning, and Quantitative Ability.",
        papers: [
      ...
      previousYearLink:
        "https://iimcat.ac.in/per/g06/pub/32842/ASM/WebPortal/1/index.html",
      examDates: [
      ...
      eligibility: [
        {
          criteria: "Educational Qualification",
          details: "Bachelor's degree with 50% marks (45% for SC/ST/PwD)",
        },
        { criteria: "Age Limit", details: "No age limit" },
        {
          criteria: "Final Year",
          details: "Final year students can also apply",
        },
      ],
    },
  };
          ...
          <div className="space-y-8">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                {currentExam.overview.title}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                {currentExam.overview.content}
              </p>
              ...
              {currentExam.previousYearLink && (
                <div className="mt-6">
                  <a
                    href={currentExam.previousYearLink}
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                {selectedExam} Eligibility Criteria
              </h2>
              <div className="bg-cyan-100 rounded-lg p-4 mb-4">
                <h3 className="text-xl font-semibold text-center text-gray-700">
                  {selectedExam} Eligibility Criteria
              ...
              <>
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-6">
                    Syllabus is based on Physics, Chemistry, and Mathematics
                    (Class 11/12 NCERT). Confirm updates on the NTA exam portal
                    each year.
                  </p>

                  <div className="bg-cyan-100 rounded-lg p-4 mb-4">
                    <h3 className="text-xl font-semibold text-center text-gray-700">
                      Breakdown of JEE Main 2026 Syllabus
                    </h3>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                    <div>
                      ...
                      <ul className="space-y-2">
                        {currentExam.syllabus.mathematics.map(
                          (topic, index) => (
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-6">
                    For pattern, structure, and marking, see the table below.
                  </p>
                    ...
                    <table className="w-full border-collapse border border-gray-200">
                      <thead>
                        <tr className="bg-gray-50">
                          <th className="border border-gray-200 py-3 px-4 text-left font-semibold text-gray-700">
                            Particulars
                          </th>
                          <th className="border border-gray-200 py-3 px-4 text-left font-semibold text-gray-700">
                            Paper 1 (B.Tech/B.E.)
                      ...
                      <tbody>
                        {currentExam.examPattern.map((row, index) => (
                          <tr key={index}>
                            <td className="border border-gray-200 py-3 px-4 font-medium text-gray-900">
                              {row.particular}
                            </td>
                            <td className="border border-gray-200 py-3 px-4 text-gray-700">
                              {row.paper1}
                            </td>
                            <td className="border border-gray-200 py-3 px-4 text-gray-700">
                              {row.paper2A}
                ...
                <div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">
                    {currentExam.advanced.title}
                  </h2>
                  <p className="text-gray-700 mb-6">
                    {currentExam.advanced.description}
                  </p>
                  ...
                  <p className="text-gray-700 mb-4">
                    The main exam is typically conducted in mid-May.
                  </p>
...
//         ]
//       },
//       previousYearLink: "https://jeemain.nta.nic.in/previous-year-question-papers/", // 🔗 Added link here
//       examDates: [
...
//               {/* 🔗 Previous Year Question Papers link */}
//               {currentExam.previousYearLink && (
//                 <div className="mt-6">
//                   <a
//                     href={currentExam.previousYearLink}
