...
const requests = [
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/api/mentors/${mentorData._id}`,
        {
          profilePic: imageUrl,
        }
      );
  ...
  //     const totalFeedback = session.feedbacks.reduce(
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex flex-col space-y-8 flex-1 lg:max-w-sm">
            ...
            <Card className="flex flex-col h-full">
              <CardHeader className="text-center">
                <Avatar
                  className="h-32 w-32 mx-auto mb-4 cursor-pointer"
          ...
          <div className="flex-1 flex flex-col">
            <Card className="flex flex-col flex-grow">
              ...
              <CardContent className="space-y-4 overflow-y-auto h-[80vh]">
                {postedSessions.map((session: any, index: number) => (
                  <div
                    key={index}
