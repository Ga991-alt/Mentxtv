...
const BookingSessions = () => {
  ...
  {/* Left section */}
  <div>
    <h1 className="text-lg sm:text-xl md:text-3xl font-bold mb-4 sm:mb-4">
      Book Your Sessions
    </h1>
  ...
  <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3">
    <span className="font-bold text-black md:text-1xl">Filter Options:</span>
    ...
    <div className="w-full sm:w-48">
      ...
      >
        ...
        <SelectContent>
          <SelectItem value="All"><span className="font-semibold">All Categories</span></SelectItem>
          {Object.keys(mentorshipCategories).map((main) => (
    ...
    <div className="w-full sm:w-48">
      ...
      >
        ...
        <SelectContent>
          <SelectItem value="All"><span className="font-semibold">All</span></SelectItem>
          {selectedMainCategory !== "All" &&
            mentorshipCategories[selectedMainCategory].map((sub) => (
